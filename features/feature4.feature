...
2. run the following command:
  ...
  Scenario Outline: Post teacher register
    * Post to service api "<URL>" with '<data>' and I should get the '<expectval>'
    Examples: 
      | URL                                    | data                                                                                                                                                                                               | expectval                                             |
      | http://localhost:3000/teacher/register | { "Email":"abhishekgiri7316@gmail.com","Password":"asd","FirstName":"Abhishek","LastName":"Giri","DOB":"1997-12-03","Gender":"male","Phone":"9803332022","Address":"Nayabazar","Bio":"Loremipsum", "StudentID":"1" } | { "status": 200, "message": "New Teacher Registered"} |