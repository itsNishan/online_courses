...
2. run the following command:
  ...
  Scenario Outline: Get course data
    * Get the service api "<URL>" and i should get the '<expectval>'
    Examples: 
      | URL                                | expectval                                                                                                                                                                                                                                                                                                                           |
      | http://localhost:3000/get/course/1 | { "status": 200,"message": "Course data fetched","info": {"id": 1,"title":"Java","description":"this is good course","credit":20,"fee":2000,"course_image":"abc.jpg","start_date":"2020-12-07T13:03:47.000Z","end_date":"2021-02-02T13:03:47.000Z","createdAt": "2020-12-07T13:03:47.000Z","updatedAt": "2020-12-07T13:03:47.000Z"} |